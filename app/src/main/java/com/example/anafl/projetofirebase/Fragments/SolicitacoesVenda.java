...
import com.example.anafl.projetofirebase.Activity.PaginaPedidoSolVenda;
 ...
 * {@link SolicitacoesVenda.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SolicitacoesVenda#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SolicitacoesVenda extends Fragment implements ClickRecyclerViewInterfacePedido {
     ...
     * @return A new instance of fragment SolicitacoesVenda.
     */
    // TODO: Rename and change types and number of parameters
    public static SolicitacoesVenda newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.fragment_solicitacoes_venda, container, false);
    ...
    private void lerPedidos(){
        ...
        Query query;
        query = mDatabaseReference.child("pedidos").orderByChild("idVendedor").equalTo(uid);
    ...
    public void instanciarRecyclerView(View view, List<Pedido> listPedidos){
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.rvPedidosSolVendas);
    ...
    public void onCustomClick(Object object) {
        ...
        Intent paginaPedidoSolVenda = new Intent(getContext(), PaginaPedidoSolVenda.class);
        paginaPedidoSolVenda.putExtras(bundle);

        startActivity(paginaPedidoSolVenda);
    }
