 ...
 */
public class Vendas extends Fragment implements ClickRecyclerViewInterfacePedido {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.fragment_vendas, container, false);
    ...
    public void instanciarRecyclerView(View view, List<Pedido> listPedidos){
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.rvPedidosVendas);
